    ...
    def _get_config_setting(self, name, default=None):
        try:
            ...
            if name.startswith("color_"):
                ...
                if _name == "hidden":
                    param = "hidden"
                # TODO: removing this statement does not fail newly added "test_color_10()" but
                # would fail easily in the bar. the test is there to raise awareness about this.
                # TODO: i made "test_color_11()" too to show how the tests can be wrong as it
                # does not necessarily print everything correctly (i.e. orange vs ORaNgE).
